...
| `education.html` | K-12 / higher ed — CTE Curriculum, Learning Games & Simulation Design, TRPEC (founded by Dr. William Gideon), Higher Ed cards; dark research strip; teacher PD CTA | ✅ Done |
...
- [ ] `education.html` — 4 product cards (CTE Curriculum, Learning Games & Simulation Design, TRPEC → `rightpathed.com/services`, Higher Ed); dark research strip; closing.
